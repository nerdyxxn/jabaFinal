...
<body>
    ...
    <section id="sth">
                    ...
                    <c:if test="${not empty storeList}">
                        <c:forEach items="${storeList}" var="storeVO" varStatus="s">
                            ...
                            <c:if test="${not empty storeVO}">
                                ...
                                <c:if test="${storeVO.store_status == 2 }">
                                    <!-- 오픈 스위치 -->
                                    <a href="#" class="cardA doNotEnter">
                                </c:if>
                            </c:if>
        ...
        <form name="frm" id="mapForm">
            <input type="hidden" name="lat2"> <input type="hidden" name="lon2">
        </form>
    </section>
    ...
    <script>
        ...
        // store_status 가 2 이면 opacity
        $(document).ready(function() {
            $(".doNotEnter .store_card").css("opacity", "0.3");
            $(".doNotEnter").css("pointer-events", "none");
        });
    </script>
</body>
