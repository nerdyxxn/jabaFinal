			...
			<div class="account_list_container">
				<div class="account_list">
					...
					<div class="account_items">
						<input type="password" class="signin-input" id="pwd_change" name="pwd_change"
							style="font-weight: normal; padding: 12px 12px 10px;" placeholder="새로운 비밀번호를 입력해주세요">
					</div>
					<div class="account_items">
						<input type="password" class="signin-input" id="pwd_confirm" name="pwd_confirm"
							style="font-weight: normal; padding: 12px 12px 10px;" placeholder="비밀번호를 한번 더 입력해주세요">
					</div>
