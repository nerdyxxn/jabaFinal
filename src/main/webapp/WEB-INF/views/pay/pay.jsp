        ...
        <div class="container">
            <div class="contents">
                <div id="orderSummary">
                    <div class="category">
                        <p>
                            <span class="profile" style="text-decoration: none; color: grey; width: 50px;">Check out</span>
                        </p>
                    </div>
                    <div class="left_part" id="left">
                                    ...
                                    <td>
                                        <div class="pickup_tab">
                                            <div class="pickup_details">
                                                <p>
                                                    <span style="float: left; font-weight: bold; font-size: 15px;">PICK
                        ...
                        <div class="personal_info">
                            <h2>이름</h2>
                            <input type="text" id="personal_name" name="personal_name" placeholder="이름"><br>
                            <h2 style="padding-top: 5px;">전화번호</h2>
                            <input type="text" id="personal_tel" name="personal_tel" placeholder="010-XXXX-XXXX">
                        </div>
                    </div>
                </div>
                <div id="checkout-details">
                    <div class="right_part" id="right">
                                        ...
                                        <c:if test="${not empty cartList }">
                                            <c:forEach items="${cartViewVoList}" var="cartViewVoList" varStatus="s">
                                                <p>
                                                    ...
                                                    <span class="item_name">&nbsp;${cartViewVoList.menu_name }</span><span class="item_price" style="float: right">${cartViewVoList.cart_total_price }</span><br>
                        ...
                        <div class="order_request">
                            <h2>요청사항</h2>
                            <textarea cols="27" rows="3" style="resize: none; padding: 10px; border-color: white; outline-color: white;" placeholder="요청사항을 입력해주세요." id="pay_request"></textarea>
                        </div>
                    </div>
                </div>
                <div class="bottom_part">
                    <button type="button" class="btnChk" id="place_order" name="place_order">Place Order for Pick Up</button>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="modal-dialog modal-size" role="document">
            <div class="modal-content modal-size">
                            ...
                            <tr>
                                <td>
                                    <div class="asap icheck-material-teal">
                                        <input type="radio" id="asap" name="teal" value="agree" checked="checked"> <label for="asap" style="font-weight: normal;">&nbsp;&nbsp;ASAP</label>
                                    </div>
                                    <div class="later icheck-material-teal">
                                        <input type="radio" id="later" name="teal" value="denial" style="font-weight: 15px;"> <label for="later" style="font-weight: normal;">&nbsp;&nbsp;LATER</label>
                                    </div>
                                </td>
                            </tr>
                            <tr id="later_time">
                ...
                <div class="modal-footer">
                    <button type="button" class="modalBtnChk" data-dismiss="modal" aria-label="Close" id="btnChk_cancel" name="btnChk_cancel">Cancel</button>
                    <button type="button" class="modalBtnChk" id="btnChk_confirm" name="btnChk_confirm">Confirm</button>
                </div>
            </div>
        </div>
    </div>
