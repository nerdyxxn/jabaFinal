                                    ...
                                    <div class="product_card" onclick="clickProductCard(this);">
                                        <div class="product_card_detail">
                                            ...
                                            <div class="product_price">
                                                <p>
                                                    <fmt:formatNumber value="${menuVo.menu_price}" pattern="#,###" />원
                                                </p>
                                            </div>
                                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-dialog-centered" id="mmmaaa">
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="CustomCloseBtn">
                    ...
                    <div class="header-details">
                        ...
                        <div class="header-image">
                            <img src="<%=ctxPath %>${menuVo.menu_img }" alt="Aussie">
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <c:if test="${not empty sortCustomList }">
                        <c:forEach items="${sortCustomList}" var="sortCustomList" varStatus="s">
                            <div class="category">
                                ...
                                <div class="custom-content custom-grid">
                                    <c:if test="${not empty sortCustomList }">
                                        <c:forEach items="${sortCustomList}" var="sortCustomList" varStatus="s2">
                                            <div class="icheck-material-teal">
                                                ...
                                                <label for="custom1${s.count }${s2.count }" class="customClick">${sortCustomList.custom_name}</label>
                                                <div>
                                                    <span class="custom-charge">+</span><span class="custom-charge-jstl">
                                                        <fmt:formatNumber value="${sortCustomList.custom_price}" pattern="#,###" />
                                                    </span><span class="custom-charge"> 원</span>
                                                </div>
                                            </div>
                                        </c:forEach>
                                    </c:if>
                ...
                <div class="product-modal__actions">
                    <div class="quantity">
                        <button class="MuiButtonBase-root MuiIconButton-root MuiIconButton-colorPrimary Mui-disabled Mui-disabled" tabindex="-1" type="button" id="decreaseQuantity" onclick="QuantityDownFunc();">
                        ...
                        <button class="MuiButtonBase-root MuiIconButton-root MuiIconButton-colorPrimary" tabindex="0" type="button" id="increaseQuantity" onclick="QuantityUpFunc();">
                            <span class="MuiIconButton-label"><svg class="MuiSvgIcon-root" focusable="false" viewBox="0 0 24 24" aria-hidden="true" role="presentation">
        ...
        <div id="cart-menu" class="cart-menu menu-container">
            ...
            <div class="order-details">
                ...
                <div class="order-drawer-fulfilment">
                    <button class="MuiButtonBase-root MuiButton-root jss135 MuiButton-text" tabindex="0" type="button">
                        <span class="MuiButton-label">Pick up, ASAP</span><span class="MuiTouchRipple-root"></span>
                    </button>
                </div>
            </div>
            <!-- body -->
                        ...
                        <div class="cart-order-item" id="cart-order-item">
                            ...
                            <div id="cart-order-item__details">
                                ...
                                <div class="modifiers">
                                    ...
                                    <div class="price">
                                        <fmt:formatNumber value="${cartViewVoList.cart_total_price }" pattern="#,###" />원
                                    </div>
                                </div>
                            </div>
                            <button id="${cartViewVoList.order_id}" class="MuiButtonBase-root MuiIconButton-root cart-order-item__remove MuiIconButton-sizeSmall" tabindex="0" type="button" onclick="deleteCart(this);">
                                <span class="MuiIconButton-label"><svg class="MuiSvgIcon-root" focusable="false" viewBox="0 0 24 24" aria-hidden="true" role="presentation">
            ...
            <div class="order-actions">
                <div class="order-actions__totals">
                    <div class="total">
                        <span>Total</span><span id="cart_total">
                            <fmt:formatNumber value="${total_price }" pattern="#,###" />원
                        </span>
                    </div>
                </div>
                <button class="MuiButtonBase-root MuiButton-root checkout loader MuiButton-contained MuiButton-containedPrimary MuiButton-fullWidth" tabindex="0" type="button" id="checkOutBtn" onclick="checkOutBtnFnc();">
