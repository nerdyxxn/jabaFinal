							...
							<div class="limiter">
								<div class="container-table100">
									<div class="wrap-table100">
										<form action="<%=ctxPath%>/admin/qna/insertQna.do"
											method="POST">
											<div class="table">
												<div class="trow theader">
													<div class="cell"></div>
													<div class="cell">
														TITLE &nbsp; <input style="background-color: #d6d9dc;" type="text" name="title" id="title" />
													</div>
												</div>
												<div class="trow">
													...
													<div class="cell" data-title="Job Title">
														CONTENT &nbsp; <input style="background-color: #d6d9dc;" type="text"
