...
<link rel="stylesheet" type="text/css" href="<%=ctxPath%>/resources/css/adminStore.css">
<!--===============================================================================================-->
</head>
								...
								<div class="wrap-table100">
                                 ...
                                 <c:if test="${not empty storeList }">
                                    <c:forEach items="${storeList }" var="store">
                                       <div class="trow">
                                          <a href="<%=ctxPath%>/admin/store/adminStoreDetail.do?store_name=${store.store_name }">
                                             <div class="cell" data-title="STORE NAME">${store.store_name }</div>
                                          </a>
                                          <div class="cell" data-title="ADDR">${store.store_addr }</div>
