...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=ctxPath%>/resources/css/adminQnaUpdate.css">
    <!--===============================================================================================-->
</head>
                    ...
                    <div class="qna-custom-bar-chart">
                        <div class="limiter">
                            <div class="container-table100">
                                <form action="<%=ctxPath%>/admin/qna/updateQna.do?qna_no=${qnaDetail.qna_no }" method="POST">
                                    <div class="wrap-table100">
                                        <div class="table">
                                            <div class="trow theader" id="theader">
                                                <div class="cell">TITLE</div>
                                                <div class="cell" id="theaderRow">
                                                    <input type="text" name="title" id="title" value="${qnaDetail.qna_title }" />
                                                </div>
                                            </div>
                                            <div class="trow">
                                                <div class="cell" data-title="NAME">CONTENT</div>
                                                <div class="cell">
                                                    <input type="text" value="${qnaDetail.qna_content }" name="content" id="content" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="btnContainer" style="padding: 10px;">
                                        <input type="submit" value="완료"> <input type="button" value="취소" onclick="javascript:location.href='<%=ctxPath%>/admin/qna/qnaList.do'" />
                                    </div>
                                </form>
                            </div>
                        </div>
