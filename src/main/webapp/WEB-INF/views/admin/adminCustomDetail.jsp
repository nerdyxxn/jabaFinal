								...
								<div class="container-table100">
                                    ...
                                    <div class="trow">
                                       ...
                                       <div class="cell" data-title="name">
                                          ${customDetail.custom_name }
                                       </div>
                                       <div class="cell" data-title="price">
                                          ${customDetail.custom_price }
                                       </div>
                                       <div class="cell" data-title="category">
                                         ${customDetail.custom_category }
                                       </div>
                                    </div>
											</div>
											<div class="btnContainer" style="float:right; padding:10px">
												...
												<input type="button" value="돌아기기" onclick="javascript:location.href='<%=ctxPath%>/admin/store/adminMenuDetail.do?menu_id=${customDetail.menu_id }'" />
											</div>
									</div>
								</div>
							</div>
