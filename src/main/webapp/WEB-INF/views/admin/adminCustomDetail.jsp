							...
							<div class="container-table100">
								...
								<div class="btnContainer" style="padding: 10px">
									<input type="button" value="수정하기"
										onclick="javascript:location.href='<%=ctxPath%>/admin/store/customUpdateDetail.do'" />
									<input type="button" value="돌아가기"
										onclick="javascript:location.href='<%=ctxPath%>/admin/store/adminMenuDetail.do?menu_id=${customDetail.menu_id }'" />
								</div>
							</div>
						</div>
					</div>
