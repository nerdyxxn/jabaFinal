                                    ...
                                    <div class="wrap-table100">
                                        <div class="table">
                                            ...
                                            <div class="trow">
                                                ...
                                                <div class="cell">
                                                    <input style="background-color: #d6d9dc;" type="text" name="menu_price" id="menu_price" />
                                                </div>
                                            </div>
                                            <div class="trow">
                                            ...
                                            <div class="trow">
                                                ...
                                                <div class="cell">
                                                    <input style="background-color: #d6d9dc;" type="text" name="menu_description" id="menu_description" />
                                                </div>
                                            </div>
                                            <div class="trow">
                                                <div class="cell" data-title="CATEGORY">CATEGORY</div>
                                                <div class="cell">
                                                    <input style="background-color: #d6d9dc;" type="text" name="menu_category" id="menu_category" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
