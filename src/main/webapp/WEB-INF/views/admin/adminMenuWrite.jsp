...
<link rel="stylesheet" type="text/css" href="<%=ctxPath%>/resources/css/adminMenuWrite.css">
<!--===============================================================================================-->
</head>
								...
								<div class="wrap-table100">
									<div class="table">
										...
										<div class="trow">
											...
											<div class="cell"><input style="background-color: #d6d9dc;" type="text" name="menu_name" id="menu_name" />
											</div>
										</div>
										<div class="trow">
											<div class="cell" data-title="PRICE">PRICE</div>
											<div class="cell">
												<input style="background-color: #d6d9dc;"
													type="text" name="menu_price" id="menu_price" />
											</div>
										</div>
										<div class="trow">
											<div class="cell" data-title="IMG">IMG</div>
											<div class="cell">
												<input type="file" name="upfile" multiple>
											</div>
										</div>
										<div class="trow">
											<div class="cell" data-title="DESCRIPTION">DESCRIPTION</div>
											<div class="cell">
												<input style="background-color: #d6d9dc;"
										...
										<div class="trow">
											...
											<div class="cell">
												<input style="background-color: #d6d9dc;"
													type="text" name="menu_category" id="menu_category" />
											</div>
										</div>
									</div>
								</div>
