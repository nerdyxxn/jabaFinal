					...
					<li id="header_inbox_bar" class="dropdown"><a
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li><a href="index.html#"> <span class="photo"><img
										alt="avatar"
										src="<%=ctxPath%>/resources/images/admin/img/ui-zac.jpg"></span>
							...
							<li><a href="index.html#"> <span class="photo"><img
										alt="avatar"
										src="<%=ctxPath%>/resources/images/admin/img/ui-divya.jpg"></span>
							...
							<li><a href="index.html#"> <span class="photo"><img
										alt="avatar"
										src="<%=ctxPath%>/resources/images/admin/img/ui-danro.jpg"></span>
							...
							<li><a href="index.html#"> <span class="photo"><img
										alt="avatar"
										src="<%=ctxPath%>/resources/images/admin/img/ui-sherman.jpg"></span>
									...
									<div class="wrap-table100">
											<div class="table">
												<div class="trow theader">
													<div class="cell"></div>
													<div class="cell">
														NAME &nbsp; <input style="background-color: #d6d9dc;" type="text"
												...
												<div class="trow">
													...
													<div class="cell" data-title="Job Title">
														PRICE &nbsp; <input style="background-color: #d6d9dc;" type="text"
												...
												<div class="trow">
													...
													<div class="cell" data-title="Job Title">
														IMG &nbsp; <input style="background-color: #d6d9dc;" type="text"
															name="img" id="img"/>
												...
												<div class="trow">
													...
													<div class="cell" data-title="Job Title">
														DESCRIPTION &nbsp; <input style="background-color: #d6d9dc;" type="text"
															name="menu_description" id="menu_description"/>
													</div>
												</div>
												<div class="trow">
													<div class="cell" data-title="Full Name">
													...
													<div class="cell" data-title="Job Title">
														CATEGORY &nbsp; <input style="background-color: #d6d9dc;" type="text"
											...
											<div class="btnContainer" style="float:right; padding:10px">
												<input type="submit" value="완료" id="menuAddBtn"> <input type="button" value="돌아기기" onclick="javascript:location.href='<%=ctxPath%>/admin/qna/qnaList.do'" />
											</div>
											</div>
										</form>
									</div>
